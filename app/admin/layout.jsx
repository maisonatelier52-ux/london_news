...
// // app/admin/layout.jsx (UPDATED with hidden scrollbar)
// "use client";
...
//   FiMenu, FiX, FiHome, FiSmile, FiLayout 
// } from "react-icons/fi";
...
//     { href: "/admin/footer",     label: "Footer",     icon: FiLayout },
//     { href: "/admin/mood-survey",label: "Mood Survey", icon: FiSmile },
//   ];
